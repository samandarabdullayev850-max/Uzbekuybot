...
NOTIFY_FREQ = {
    "uz": {"instant": "Darhol", "daily": "Kuniga 1", "weekly": "Haftada 1"},
    "ru": {"instant": "Srazu", "daily": "Raz v den", "weekly": "Raz v nedelyu"},
    "en": {"instant": "Instantly", "daily": "Once a day", "weekly": "Once a week"}
}
...
UZ = {
    ...
    "welcome": "UyBot ga xush kelibsiz! Ozbekiston buylab uy qidiring yoki elon bering.",
    "main_menu": "Asosiy menyu:",
    "btn_search": "Qidiruv",
    "btn_my_listings": "Mening elonlarim",
    "btn_add_listing": "Elon berish",
    "btn_settings": "Sozlamalar",
    "btn_help": "Yordam",
    "choose_city": "Qaysi shaharda qidirasiz?",
    "choose_deal": "Nima qidirmoqdasiz?",
    "choose_rooms": "Nechta xona?",
    "choose_price": "Narx oraligi?",
    "no_results": "Hech narsa topilmadi. Filterni ozgartiring.",
    "results_found": "{count} ta elon topildi:",
    "btn_next": "Keyingi",
    "btn_prev": "Oldingi",
    "btn_cancel": "Bekor qilish",
    "btn_skip": "Otkazib yuborish",
    "ask_deal": "Ijara yoki sotish?",
    "ask_city": "Qaysi shaharda?",
    "ask_rooms": "Nechta xona?",
    "ask_price": "Narxni kiriting ($):",
    "ask_description": "Uy haqida tavsif yozing yoki otkazib yuboring:",
    "ask_photos": "Rasmlarni yuboring (1-10 ta). Tugagach Saqlash bosing:",
    "ask_address": "Manzilni yozing:",
    "ask_phone": "Telefon raqamingizni yuboring:",
    "listing_saved": "Eloningiz saqlandi va korib chiqilmoqda.",
    "settings_title": "Bildirishnoma sozlamalari:",
    "notif_on": "Bildirishnomalar: Yoqilgan",
    "notif_off": "Bildirishnomalar: Ochirilgan",
    "choose_freq": "Qanchalik tez xabar olishni xohlaysiz?",
    "choose_limit": "Kuniga maksimum nechta xabar?",
    "limit_unlimited": "Cheksiz",
    "settings_saved": "Sozlamalar saqlandi!",
    "only_cheap_on": "Faqat arzon elonlar: Ha",
    "only_cheap_off": "Faqat arzon elonlar: Yoq",
    "new_listing_notif": "Yangi elon - sizning sorovingizga mos!",
    "help_text": "UyBot - Ozbekiston kochmas mulk boti.\n\n/start - Boshlash\n/add - Elon berish\n/settings - Sozlamalar\n/stats - Statistika",
    "stats_title": "Statistika:",
    "stats_users": "Jami foydalanuvchilar: {count}",
    "stats_listings": "Jami elonlar: {count}",
    "stats_active": "Faol elonlar: {count}",
    "stats_subs": "Faol obunalar: {count}",
}

RU = {
    "choose_language": "Tilni tanlang:",
    "welcome": "Dobro pozhalovat v UyBot! Ishchite zhilyo po vsemu Uzbekistanu.",
    "main_menu": "Glavnoe menyu:",
    "btn_search": "Poisk",
    "btn_my_listings": "Moi obyavleniya",
    "btn_add_listing": "Dobavit obyavlenie",
    "btn_settings": "Nastroyki",
    "btn_help": "Pomosh",
    "choose_city": "V kakom gorode ischete?",
    "choose_deal": "Chto ischete?",
    "choose_rooms": "Kolichestvo komnat?",
    "choose_price": "Tsena?",
    "no_results": "Nichego ne naydeno.",
    "results_found": "Naydeno {count}:",
    "btn_next": "Dalee",
    "btn_prev": "Nazad",
    "btn_cancel": "Otmena",
    "btn_skip": "Propustit",
    "ask_deal": "Arenda ili prodazha?",
    "ask_city": "V kakom gorode?",
    "ask_rooms": "Kolichestvo komnat?",
    "ask_price": "Vvedite tsenu ($):",
    "ask_description": "Opisanie ili propustite:",
    "ask_photos": "Otpravte foto (1-10):",
    "ask_address": "Adres:",
    "ask_phone": "Nomer telefona:",
    "listing_saved": "Obyavlenie sokhraneno!",
    "settings_title": "Nastroyki uvedomleniy:",
    "notif_on": "Uvedomleniya: Vkl",
    "notif_off": "Uvedomleniya: Otkl",
    "choose_freq": "Kak chasto poluchat uvedomleniya?",
    "choose_limit": "Maks uvedomleniy v den?",
    "limit_unlimited": "Bez limita",
    "settings_saved": "Nastroyki sokhraneny!",
    "only_cheap_on": "Tolko deshevle rynka: Da",
    "only_cheap_off": "Tolko deshevle rynka: Net",
    "new_listing_notif": "Novoe obyavlenie - vam podkhodit!",
    "help_text": "UyBot - nedvizhimost Uzbekistana.\n\n/start\n/add\n/settings\n/stats",
    "stats_title": "Statistika:",
    "stats_users": "Vsego polzovateley: {count}",
    "stats_listings": "Vsego obyavleniy: {count}",
    "stats_active": "Aktivnykh: {count}",
    "stats_subs": "Aktivnykh podpisok: {count}",
}

EN = {
    "choose_language": "Choose language:",
    "welcome": "Welcome to UyBot! Search for property across Uzbekistan.",
    "main_menu": "Main menu:",
    "btn_search": "Search",
    ...
    "btn_help": "Help",
    "choose_city": "Which city are you looking in?",
    "choose_deal": "What are you looking for?",
    "choose_rooms": "Number of rooms?",
    "choose_price": "Price range?",
    "no_results": "Nothing found. Try changing filters.",
    "results_found": "{count} listings found:",
    "btn_next": "Next",
    "btn_prev": "Previous",
    "btn_cancel": "Cancel",
    "btn_skip": "Skip",
    "ask_deal": "Rent or sale?",
    "ask_city": "Which city?",
    "ask_rooms": "Number of rooms?",
    "ask_price": "Enter price ($):",
    "ask_description": "Write description or skip:",
    "ask_photos": "Send photos (1-10):",
    "ask_address": "Write address:",
    "ask_phone": "Send phone number:",
    "listing_saved": "Your listing has been saved!",
    "settings_title": "Notification settings:",
    "notif_on": "Notifications: On",
    "notif_off": "Notifications: Off",
    "choose_freq": "How often do you want notifications?",
    "choose_limit": "Maximum notifications per day?",
    "limit_unlimited": "Unlimited",
    "settings_saved": "Settings saved!",
    "only_cheap_on": "Only cheap listings: Yes",
    "only_cheap_off": "Only cheap listings: No",
    "new_listing_notif": "New listing matches your search!",
    "help_text": "UyBot - Real estate bot for Uzbekistan.\n\n/start\n/add\n/settings\n/stats",
    "stats_title": "Statistics:",
    "stats_users": "Total users: {count}",
    "stats_listings": "Total listings: {count}",
    "stats_active": "Active listings: {count}",
    "stats_subs": "Active subscriptions: {count}",
}
...
def main_menu_kb(lang):
    ...
    return ReplyKeyboardMarkup([
        [t["btn_search"]],
        [t["btn_add_listing"], t["btn_my_listings"]],
...
async def cmd_stats(update, context):
    ...
    text = (
        f"{t['stats_title']}\n\n"
        f"{t['stats_users'].format(count=users)}\n"
        f"{t['stats_listings'].format(count=listings)}\n"
        f"{t['stats_active'].format(count=active)}\n"
        f"{t['stats_subs'].format(count=subs)}"
    )
...
async def cb_search(update, context):
    ...
    if d.startswith("s_city_"):
        ...
        btns = [[
            InlineKeyboardButton(DEAL_TYPES[lang][0], callback_data="s_deal_rent"),
            InlineKeyboardButton(DEAL_TYPES[lang][1], callback_data="s_deal_sale")
        ]]
...
async def show_results(q, context, lang, page):
    ...
    nav = []
    if page > 0:
        nav.append(InlineKeyboardButton(t["btn_prev"], callback_data=f"s_page_{page - 1}"))
    if (page + 1) * 3 < total:
        nav.append(InlineKeyboardButton(t["btn_next"], callback_data=f"s_page_{page + 1}"))

    for i, l in enumerate(listings):
        lines = [l.get("title", "—")]
        if l.get("price"):
            lines.append(f"${l['price']}" + (" / oy" if l.get("deal_type") == "rent" else ""))
        if l.get("rooms"):
            lines.append(f"{l['rooms']} xona")
        if l.get("address"):
            lines.append(l["address"])
        if l.get("description"):
            lines.append(l["description"][:150])
        if l.get("phone"):
            lines.append(l["phone"])
        if l.get("source") and l["source"] != "bot":
            lines.append(f"Manba: {l['source']}")
        text = "\n".join(lines)
...
async def add_start(update, context):
    ...
    btns = [
        [
            InlineKeyboardButton(DEAL_TYPES[lang][0], callback_data="nl_deal_rent"),
            InlineKeyboardButton(DEAL_TYPES[lang][1], callback_data="nl_deal_sale")
        ],
        [InlineKeyboardButton(t["btn_cancel"], callback_data="nl_cancel")]
    ]
...
async def settings_start(update, context):
    ...
    kb = InlineKeyboardMarkup([
        [InlineKeyboardButton(t["notif_on"] if is_active else t["notif_off"], callback_data="set_notif")],
        [InlineKeyboardButton(t["only_cheap_on"] if only_cheap else t["only_cheap_off"], callback_data="set_cheap")],
        [InlineKeyboardButton(fl[freq], callback_data="set_freq")],
        [InlineKeyboardButton(f"Limit: {limit_label}", callback_data="set_limit")],
        [InlineKeyboardButton("Tilni ozgartirish", callback_data="set_lang")]
    ])
...
async def cb_settings(update, context):
    ...
    if d == "set_notif":
        ...
        fl = NOTIFY_FREQ[lang]
        kb = InlineKeyboardMarkup([
            [InlineKeyboardButton(fl["instant"], callback_data="sf_instant")],
            [InlineKeyboardButton(fl["daily"], callback_data="sf_daily")],
            [InlineKeyboardButton(fl["weekly"], callback_data="sf_weekly")]
        ])
        ...
        kb = InlineKeyboardMarkup([
            [InlineKeyboardButton(t["limit_unlimited"] if l == 0 else f"{l} ta", callback_data=f"sl_{l}")]
            for l in DAILY_LIMITS
        ])
...
async def main():
    ...
    tg_app.add_handler(CommandHandler("add", add_start))
    tg_app.add_handler(CommandHandler("settings", settings_start))
    tg_app.add_handler(CommandHandler("stats", cmd_stats))
    tg_app.add_handler(CallbackQueryHandler(cb_lang, pattern="^lang_"))
    tg_app.add_handler(CallbackQueryHandler(cb_search, pattern="^(s_city_|s_deal_|s_rooms_|s_price_|s_page_)"))
    tg_app.add_handler(CallbackQueryHandler(cb_listing, pattern="^nl_"))
    tg_app.add_handler(CallbackQueryHandler(cb_settings, pattern="^(set_|sf_|sl_)"))
    tg_app.add_handler(MessageHandler(filters.Regex("^(Qidiruv|Poisk|Search)$"), search_start))
    tg_app.add_handler(MessageHandler(filters.Regex("^(Elon berish|Dobavit obyavlenie|Add listing)$"), add_start))
    tg_app.add_handler(MessageHandler(filters.Regex("^(Sozlamalar|Nastroyki|Settings)$"), settings_start))
